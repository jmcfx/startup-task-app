...
sealed class UserItemEvent with _$UserItemEvent {
  const factory UserItemEvent.getItems([
    @Default(1) int page,
  ...
  const factory UserItemEvent.updateItem(UserItemEntity item) =
      _UpdateItemEvent;
  const factory UserItemEvent.selectItem(UserItemEntity item) =
      _SelectItemEvent;
}
